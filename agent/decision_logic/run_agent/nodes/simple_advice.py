...
from helpers.advise_support import AdviseSupport  # we added some helpers for this
...
def node(state: ChatState) -> ChatState:
    ...
    # And punch it into our state to be finalised
