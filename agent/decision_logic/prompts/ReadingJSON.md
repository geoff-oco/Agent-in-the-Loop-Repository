...
Ignore 'bases' as these are simply an expression of the current map screen and not pertinent to the final result.
'actions' is very important, this is the section which shows all moves made so pay attention after actions. It is critical to analyse to improve current LER.
